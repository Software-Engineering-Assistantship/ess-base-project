...
Given Eu estou no menu “Formas de pagamento”
And O usuário de username “clara_abk” tem o cartão com número “************4729” cadastrado
When Eu clico em “Excluir” para o cartão com número “************4729”
Then Eu vejo uma mensagem de confirmação para a exclusão do cartão
And O cartão com número “************4729” não está mais na lista de cartões cadastrados

/*
  ...
  - You are about to alter the column `card_id` on the `CardPayment` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.

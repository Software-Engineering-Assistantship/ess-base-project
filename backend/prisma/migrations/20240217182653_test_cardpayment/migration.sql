/*
  ...
  - Added the required column `card_number` to the `CardPayment` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_CardPayment" ("card_id", "cvv", "expire_date", "name", "number", "password", "type") SELECT "card_id", "cvv", "expire_date", "name", "number", "password", "type" FROM "CardPayment";
